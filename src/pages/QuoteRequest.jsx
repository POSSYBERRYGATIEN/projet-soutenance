      ...
      <form onSubmit={handleSubmit} className="mt-6">
        ...
        <div className="mb-6">
          ...
          <select name="service" className="form-select" value={form.service} onChange={handleChange} required>
            ...
            <option value="Installation d'alarmes">Installation de système de Surveillance</option>
            <option value="Des menagères ">Menagère</option>
            <option value="Des domestiques ">Domestique</option>
            <option value="Des agents d'entretient">Agent d'entretient</option>
          </select>
        </div>
        <div className="mb-6">
